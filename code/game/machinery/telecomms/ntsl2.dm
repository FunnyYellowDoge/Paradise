...
/datum/nttc_configuration
	...
	var/all_jobs = list(
		...
		// Engineeering
		"Tecnico Atmosferico" = "engradio",
		"Jefe de Ingenieros" = "engradio",
		"Electricista" = "engradio",
		"Tecnico de Motor" = "engradio",
		"Experto en Soporte de Vida" = "engradio",
		"Tecnico de Mantenimiento" = "engradio",
		"Mecanico" = "engradio",
		"Ingeniero" = "engradio",
		// ERT
		...
		// Science
		"Anomalista" = "sciradio",
		"Ingeniero Biomecanico" = "sciradio",
		"Investigador Quimico" = "sciradio",
		"Genetista" = "sciradio",
		"Mechatronic Engineer" = "sciradio",
		"Investigador de Plasma" = "sciradio",
