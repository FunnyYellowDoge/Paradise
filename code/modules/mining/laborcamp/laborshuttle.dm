/obj/machinery/computer/shuttle/labor
	...
	shuttleId = "laborcamp"
	possible_destinations = "laborcamp_home;laborcamp_away;laborcamp_asteroid"
...
/obj/machinery/computer/shuttle/labor/one_way
	...
	possible_destinations = "laborcamp_away;laborcamp_asteroid"
...
/obj/machinery/computer/shuttle/labor/one_way/Topic(href, href_list)
	if(href_list["move"])
		...
		if(S && S.name == "laborcamp_away" || S.name == "laborcamp_asteroid")
			to_chat(usr, "<span class='warning'>Shuttle is already at an outpost!</span>")
			return 0
	..()
